...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="overlay">
            ...
            <h1 class="title">QUINMAT SARL</h1>
    ...
    <div class="box text-center">
        <div class="box-item">
            ...
            <p>Des produits pour les professionnels et les particuliers, des outils électriques et manuels, des matériaux de construction.
            </p>
        </div>
        <div class="box-item">
            <i class="ti-home"></i>
        ...
        <div class="box-item">
            ...
            <p>
                Fournit des équipements médicaux tels que des lits d’hôpitaux, des fauteuils roulants et des matériels de diagnostic.
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-sm-4 col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <img src="{{asset('assets/imgs/quinmat-logo-quin.jpg')}}">
                ...
                <div class="col-sm-4 col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <img src="{{asset('assets/imgs/quinmat-logo-pap.jpg')}}">
                ...
                <div class="col-sm-4 col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <img src="assets/imgs/quinmat-logo-med.jpg">
                ...
                <div class="col-sm-4 col-md-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <img src="assets/imgs/quinmat-logo-mob.jpg">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="card img-wrapper">
                        <img src="assets/imgs/products/22.jpg" alt="">
                        <div class="overlay">
                    ...
                    <div class="card img-wrapper">
                        <img src="assets/imgs/products/11.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-infos">
                    ...
                    <div class="card img-wrapper">
                        <img src="assets/imgs/products/prod-2.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-infos">
                ...
                <div class="col-sm-4">
                    <div class="card img-wrapper">
                        <img src="assets/imgs/products/prod-1.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-infos">
                                <h5>Product Title 4</h5>
                                <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
                                <a href="javascript:void(0)"><i class="ti-link"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="card img-wrapper">
                        <img src="assets/imgs/products/prod-3.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-infos">
                ...
                <div class="col-sm-4">
                    <div class="card img-wrapper">
                        <img src="assets/imgs/products/33.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-infos">
                                <h5>Product Title 6</h5>
                                <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
                                <a href="javascript:void(0)"><i class="ti-link"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="card img-wrapper">
                        <img src="assets/imgs/products/456.png" alt="">
                        <div class="overlay">
                            <div class="overlay-infos">
                                <h5>Product Title 7</h5>
                                <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
                                <a href="javascript:void(0)"><i class="ti-link"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="card img-wrapper">
                        <img src="assets/imgs/products/prod-4.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-infos">
                                <h5>Product Title 8</h5>
                                <a href="javascript:void(0)"><i class="ti-zoom-in"></i></a>
                                <a href="javascript:void(0)"><i class="ti-link"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-1">
                            <button class="btn btn-outline-primary w-lg rounded">
                                <div class="p-1">
                                     S'abonner
                                </div>
                            </button>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <iframe width="100%" height="475" src="https://www.facebook.com/plugins/video.php?height=420&href=https%3A%2F%2Fwww.facebook.com%2FQuinmatlshi%2Fvideos%2F1037023190249461%2F&show_text=false&width=560&t=0"
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card blog-post my-4 my-sm-5 my-md-0">
                        <img src="assets/imgs/quinmat-medical-1.jpg" alt="">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card blog-post my-4 my-sm-5 my-md-0">
                        <img src="assets/imgs/quinmat-papeterie-1.jpg" alt="">
                        <div class="card-body">
                            <div class="details mb-3">
                ...
                <div class="col-md-4">
                    <div class="card blog-post my-4 my-sm-5 my-md-0">
                        <img src="assets/imgs/quinmat-0.png" alt="">
                        <div class="card-body">
                            <div class="details mb-3">
            ...
            <div class="row mt-5">
                <div class="col-sm-6 col-md-4">
                    <div class="card blog-post text-center my-4 my-sm-5 my-md-0">
                        <img  src="assets/imgs/scolar-back.jpg">
                        <div class="card-body">
        ...
        @if(true)
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <div class="card text-center mb-4">
                            <img src="assets/imgs/catalog-3.jpg">
                            <div class="card-body">
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card text-center mb-4">
                            <img src="assets/imgs/catalog-2.jpg" alt="">
                            <div class="card-body">
                                <h6 class="small text-primary font-weight-bold">Catalogue</h6>
                    ...
                    <div class="col-sm-6 col-md-4">
                        <div class="card text-center my-4 my-sm-5 my-md-0">
                            <img class="" src="assets/imgs/catalog-4.jpg" alt="">
                            <div class="card-body">
                                <h6 class="small text-primary font-weight-bold">Catalogue</h6>
                ...
                <div class="footer-lists">
                    <ul class="list">
                        ...
                        <li class="list-body">
                            ...
                            <p>Nous sommes fiers de servir nos clients avec les meilleurs produits et services possibles.</p>
                            <p class="mt-3">
                    ...
                    <ul class="list">
                        ...
                        <li class="list-body">
                            ...
                            <p><i class="ti-location-pin"></i> 650 Avenue Moëro, Lubumbashi, Republique Democratique du Congo </p>

                            <p><i class="ti-mobile"></i>(+243) 770 001 234</p>
                            <p><i class="ti-email"></i>info@quinmat.com</p>
